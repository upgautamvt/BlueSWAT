...
#ifndef IFW_L2CAP_INTERNAL_H
#define IFW_L2CAP_INTERNAL_H
...
#else
#define BT_L2CAP_RX_MTU                                                        \
	(CONFIG_BT_RX_BUF_LEN - BT_HCI_ACL_HDR_SIZE - BT_L2CAP_HDR_SIZE)
#endif
