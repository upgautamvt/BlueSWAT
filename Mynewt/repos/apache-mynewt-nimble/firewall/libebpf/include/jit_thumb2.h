...
static inline u32 _thumb32_RSBW_REG_T1(s8 Rd, s8 Rn, s8 Rm, s32 shiftImm5,
                                       u8 srtype, u8 flagS)
{
...
static inline u32 _thumb32_SBCW_T2(s8 Rd, s8 Rn, s8 Rm, s32 shiftImm5,
                                   u8 srtype, u8 flagS)
{
    s32 imm3 = (shiftImm5 >> 2) & 0b111;
    s32 imm2 = shiftImm5 & 0b11;
...
static inline u32 _thumb32_ADDW_REG_T3(s8 Rd, s8 Rn, s8 Rm, s32 offImm5,
                                       u8 srtype, u8 flagS)
{
    u32 imm3 = (offImm5 >> 2) & 0b111;
    u32 imm2 = offImm5 & 0b11;
...
static inline u32 _thumb32_AND_REG_T2(s8 Rd, s8 Rn, s8 Rm, s32 offImm5,
                                      u8 srtype, u8 flagS)
{
    u32 imm3 = (offImm5 >> 2) & 0b111;
    u32 imm2 = offImm5 & 0b11;
...
static inline u32 _thumb32_SUB_REG_T2(s8 Rd, s8 Rn, s8 Rm, s32 shiftOff5,
                                      u8 srtype, u8 flagS)
{
...
static inline u32 _thumb32_STRD_IMM_T1(const s8 RnSrc[], s8 RtDst, s16 offImm8)
{
    u32 P = offImm8 != 0;
    u32 U = offImm8 > 0, W = 0;
    u32 imm8 = offImm8 > 0 ? offImm8 : -offImm8;
...
static inline u32 _thumb32_EOR_REG_T2(s8 Rd, s8 Rn, s8 Rm, s32 shiftImm5,
                                      u8 srtype, u8 flagS)
{
    u32 imm3 = (shiftImm5 >> 2) & 0b111;
    u32 imm2 = shiftImm5 & 0b11;
...
// type: Shift_C(R[m], shift_t, shift_n, APSR.C);
static inline u32 _thumb32_ORRW_REG_T2(s8 Rd, s8 Rn, s8 Rm, s32 shiftImm5,
                                       u8 srtype, u8 flagS)
{
    if (shiftImm5 < 0 || shiftImm5 > 0b11111)
    {
